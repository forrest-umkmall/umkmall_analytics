"""
Ingest AI chat sessions data from Supabase (Postgres).

This script pulls AI chat session data from the product database.
"""
...
SOURCE_NAME = 'ai_chat_sessions'
SOURCE_DB_URL = os.getenv('PRODUCT_DB_URL')


def ingest_ai_chat_sessions():
    """
    Ingest AI chat sessions data from the product database.
    """
